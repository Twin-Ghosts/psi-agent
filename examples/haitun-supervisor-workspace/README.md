...
```text
workspace/tob/wiki/supervisor/maps/<domain>.yaml
```
...
```text
workspace/tob/wiki/supervisor/users/<user-hash>/domains/<domain>.yaml
```
...
```powershell
uv run --no-cache python workspace/tob/demo_supervisor_scenarios.py --output artifacts/supervisor-scenarios
```
