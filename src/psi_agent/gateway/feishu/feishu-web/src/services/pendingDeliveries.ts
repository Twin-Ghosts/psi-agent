/** Local-only record of deliverable basenames that arrived but were not yet saved. */
const LS_KEY = "feishu-web-pending-deliveries";
const CHANGED_EVENT = "feishu-pending-deliveries-changed";
...
export function subscribePendingDeliveries(onChanged: () => void): () => void {
