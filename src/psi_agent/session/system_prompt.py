...
class SystemPrompt:
    ...
    async def from_workspace(cls, workspace_path: Path, session_id: str) -> SystemPrompt:
        ...
        builder, checker, compaction_fn, after_turn = await cls._load_module(workspace_path, session_id)
        return cls(builder=builder, checker=checker, compaction_fn=compaction_fn, after_turn=after_turn)
    ...
    async def _load_module(
        ...
        try:
            ...
            sys.modules.pop(module_name, None)
            return None, None, None, None
        return builder, checker, compaction_fn, after_turn
