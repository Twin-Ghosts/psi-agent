...
- **零新增依赖 / src 零改动**：全部落在 `workspace/tob/` 内。
...
**Files:**
- Modify: `workspace/tob/tools/_feishu_impl.py`
- Modify: `workspace/tob/tools/feishu_auth.py`
- Modify: `workspace/tob/tools/feishu_docs.py`
- Modify: `workspace/tob/tools/feishu_wiki.py`
- Modify: `workspace/tob/tools/feishu_doc.py`
- Modify: `workspace/tob/tools/feishu_bitable.py`
- Modify: `workspace/tob/tools/feishu_task.py`
- Modify: `workspace/tob/tools/feishu_drive.py`
- Modify: `workspace/tob/tests/test_feishu.py`
- Modify: `workspace/tob/TOOLS.md`
...
**Files:**
- Modify: `workspace/tob/tools/_feishu_impl.py`
- Modify: `workspace/tob/tools/feishu_sheet.py`
- Add: `workspace/tob/skills/feishu-todo-board-sync/SKILL.md`
- Modify: `workspace/tob/tests/test_feishu.py`
- Add: `workspace/tob/tests/test_feishu_todo_board_sync.py`
- Modify: `workspace/tob/TOOLS.md`
- Modify: `workspace/tob/AGENTS.md`（工具表 + 技能列表）
...
- Add: `workspace/tob/tools/_oauth_receiver.py`
- Modify: `workspace/tob/tools/_feishu_impl.py`
- Modify: `workspace/tob/tools/feishu_auth.py`
- Modify: `workspace/tob/TOOLS.md`
- Modify: `workspace/tob/AGENTS.md`（工具表 + 环境变量表）
- Add: `tests/psi_agent/gateway/test_oauth_manager.py`
- Add: `tests/psi_agent/gateway/test_oauth_endpoints.py`
- Add: `workspace/tob/tests/test_oauth_receiver.py`
- Modify: `workspace/tob/tests/test_feishu.py`
