...
**Files:**
- Modify: `src/psi_agent/channel/feishu/client.py`
- Modify: `workspace/tob/tools/_feishu_impl.py`、`tools/feishu_approval.py`、`TOOLS.md`
- Modify: `tests/psi_agent/channel/feishu/test_feishu.py`、`workspace/tob/tests/test_feishu.py`
- Modify: `src/psi_agent/channel/AGENTS.md`
