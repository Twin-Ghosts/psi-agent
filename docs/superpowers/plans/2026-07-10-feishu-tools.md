...
- `workspace/tob/tools/_feishu_impl.py` — 共享实现层：SDK 懒加载、client 缓存、`_invoke`、请求 builder、返回归一化、doc/drive 各操作的 impl 函数。
- `workspace/tob/tools/feishu_doc.py` — 薄壳，1 工具 `feishu_doc_read`。
- `workspace/tob/tools/feishu_drive.py` — 薄壳，4 工具。
- `workspace/tob/tests/test_feishu.py` — 单元测试，mock `_invoke`，不打真实 API。
- `workspace/tob/AGENTS.md` — 工具表加行（文档收尾任务内）。
...
**Files:**
- Create: `workspace/tob/tools/_feishu_impl.py`
- Test: `workspace/tob/tests/test_feishu.py`
...
在 `workspace/tob/tests/test_feishu.py`：
...
Run: `uv run pytest workspace/tob/tests/test_feishu.py -q -p no:cacheprovider -c /dev/null`
Expected: FAIL — `ModuleNotFoundError: No module named '_feishu_impl'`

- [ ] **Step 3: 写最小实现**

创建 `workspace/tob/tools/_feishu_impl.py`：
...
```bash
git add workspace/tob/tools/_feishu_impl.py workspace/tob/tests/test_feishu.py
...
**Files:**
- Modify: `workspace/tob/tools/_feishu_impl.py`（追加 4 个 impl 函数 + 1 个 reply builder + import）
- Test: `workspace/tob/tests/test_feishu.py`（追加）
...
**Files:**
- Create: `workspace/tob/tools/feishu_drive.py`
- Test: `workspace/tob/tests/test_feishu.py`（追加加载校验）
...
创建 `workspace/tob/tools/feishu_drive.py`：
...
```bash
git add workspace/tob/tools/feishu_drive.py workspace/tob/tests/test_feishu.py
...
**Files:**
- Modify: `workspace/tob/tools/_feishu_impl.py`（追加 doc 读取 impl + 3 个 builder）
- Create: `workspace/tob/tools/feishu_doc.py`
- Test: `workspace/tob/tests/test_feishu.py`（追加）
...
创建 `workspace/tob/tools/feishu_doc.py`：
...
```bash
git add workspace/tob/tools/_feishu_impl.py workspace/tob/tools/feishu_doc.py workspace/tob/tests/test_feishu.py
...
**Files:**
- Modify: `workspace/tob/AGENTS.md`（工具表加行 + 前置条件）
...
在 `workspace/tob/AGENTS.md` 第 58 行（`browser` 那行）之后插入：
...
Run:
```bash
uv run ruff check workspace/tob/tools/feishu_doc.py workspace/tob/tools/feishu_drive.py workspace/tob/tools/_feishu_impl.py workspace/tob/tests/test_feishu.py
uv run ruff format --check workspace/tob/tools/feishu_doc.py workspace/tob/tools/feishu_drive.py workspace/tob/tools/_feishu_impl.py workspace/tob/tests/test_feishu.py
uv run ty check .
uv run pytest workspace/tob/tests/test_feishu.py -q -p no:cacheprovider -c /dev/null
```
...
```bash
git add workspace/tob/AGENTS.md
