...
`src/psi_agent/session/AGENTS.md` and `workspace/tob/AGENTS.md`;
...
- `workspace/tob/tools/_user_profile.py`: identity-safe storage, migration, topics, double-speed EMA, global profile, and locking.
- `workspace/tob/systems/system.py`: single adaptive prompt injection and Wiki lookup fallback.
- `workspace/tob/tools/_llm_wiki_impl.py`: reusable search-to-related recommendation helper if existing primitives cannot express the fallback cleanly.
...
- `src/psi_agent/session/AGENTS.md`, `workspace/tob/AGENTS.md`: lifecycle and storage documentation.
...
**Files:**
- Modify: `workspace/tob/tools/_user_profile.py`
- Modify: `workspace/tob/tools/profile_tools.py`
...
```bash
git add workspace/tob/tools/_user_profile.py workspace/tob/tools/profile_tools.py tests/integration/test_haitun_profile.py
...
```bash
git add workspace/tob/tools/_user_profile.py tests/integration/test_haitun_profile.py
...
**Files:**
- Modify: `workspace/tob/systems/system.py`
- Modify: `workspace/tob/tools/_llm_wiki_impl.py`
- Test: `tests/integration/test_haitun_profile.py`
...
```bash
git add workspace/tob/systems/system.py workspace/tob/tools/_llm_wiki_impl.py tests/integration/test_haitun_profile.py
...
```bash
git add workspace/tob/systems/system.py workspace/tob/tools/_user_profile.py src/psi_agent/session/agent.py tests/integration/test_haitun_profile.py tests/psi_agent/session/test_agent.py
...
- Modify: `workspace/tob/AGENTS.md`
- Modify: `README.md`
- Modify: `README_en.md`
...
uv run ruff check src tests workspace/tob/systems/system.py workspace/tob/tools/_user_profile.py workspace/tob/tools/_llm_wiki_impl.py
...
```bash
git add src/psi_agent/session/AGENTS.md workspace/tob/AGENTS.md README.md README_en.md
