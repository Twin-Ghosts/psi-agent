...
- `workspace/tob/tools/trigger_manage.py`、`_runtime_paths.py`
- `workspace/tob/AGENTS.md`、`skills/feishu-event-remind/SKILL.md`
...
（实现后跑：`uv run pytest tests/psi_agent/session/test_event_protocol.py workspace/tob/tests/test_trigger_manage.py --override-ini="addopts="`）
